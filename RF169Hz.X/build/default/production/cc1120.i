...
# 41 "./mcc_generated_files/system/../uart/eusart1.h" 2
...
void CC1120_Reset(void)
{
    ...
    _delay((unsigned long)((5)*(32000000U/4000.0)));
}
# 28 "cc1120.c"
uint8_t CC1120_ReadReg(uint16_t addr)
{
    ...
    if (addr <= 0x2F) {
        ...
        SPI1_ByteExchange(0x80 | (uint8_t)(addr & 0x3F));
        result = SPI1_ByteExchange(0x00);
    } else {

        SPI1_ByteExchange(0x2F | 0x80);
...
void CC1120_WriteReg(uint16_t addr, uint8_t value)
{
    ...
    if (addr <= 0x2F) {
        ...
        SPI1_ByteExchange(0x00 | (uint8_t)(addr & 0x3F));
        SPI1_ByteExchange(value);
    } else {

        SPI1_ByteExchange(0x2F | 0x00);
        SPI1_ByteExchange((uint8_t)(addr & 0xFF));
        SPI1_ByteExchange(value);
    }
...
{
    do { LATCbits.LATC5 = 0; } while(0);
    _delay((unsigned long)((10)*(32000000U/4000000.0)));
...
uint8_t CC1120_WriteTXFIFO(const uint8_t* data, uint8_t length)
{
    ...
    uint8_t status = SPI1_ByteExchange(0x40 | 0x3F);
