 ...
 * Addresses verified against CC1120 datasheet SWRS112H + SmartRF Studio
 * register export. Previous version of this header had FREQ_IF_CFG missing
 * at 0x0F, which shifted EVERY register from 0x0F to 0x2E by -1, so all
 * the radio configuration was being written to the wrong addresses. */
...
#define CC1120_GBIAS6           0x28
#define CC1120_GBIAS5           0x29
#define CC1120_GBIAS4           0x2A
#define CC1120_GBIAS3           0x2B
#define CC1120_GBIAS2           0x2C
#define CC1120_GBIAS1           0x2D
#define CC1120_GBIAS0           0x2E
#define CC1120_IFAMP            0x2F
#define CC1120_LNA              0x30
#define CC1120_RXMIX            0x31
